...
class AdSync(models.TransientModel):
    ...
    #         pass
    #     else:
    #         self.env['ad.sync_log'].sudo().create({'name': 'Группы AD', 'is_error': True, 'result': 'Нет учетных данных для подключения'})
    #         notification = {
    #             'type': 'ir.actions.client',
    #             'tag': 'display_notification',
    #             'params': {
    ...
    #         self.env['ad.sync_log'].sudo().create({'name': 'Группы AD', 'is_error': True, 'result': 'Невозможно соединиться с AD. Ошибка: ' + str(e)})
    #         notification = {
    #             'type': 'ir.actions.client',
    #             'tag': 'display_notification',
    #             'params': {
